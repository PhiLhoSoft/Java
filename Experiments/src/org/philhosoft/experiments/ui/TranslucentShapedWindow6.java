 ...
 * @author PhiLho
 */
// That's where conditional compilation would be useful, to cope with Java 6 and 7 in the same go.
public class TranslucentShapedWindow6
{
	...
	public TranslucentShapedWindow6()
	{
		m_frame = new JFrame();
		...
		AWTUtilities.setWindowOpacity(m_frame, 1.0f);
		AWTUtilities.setWindowOpaque(m_frame, false);
...
//		m_dragHandle.setSize(200, 50);
	...
	public void shapeWindow()
	{
		...
		AWTUtilities.setWindowShape(m_frame, path);
	}
	...
	public static void main(String[] args)
	{
		SwingUtilities.invokeLater(new Runnable()
		{
			...
			public void run()
			{
				TranslucentShapedWindow6 dc = new TranslucentShapedWindow6();
